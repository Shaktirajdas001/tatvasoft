    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" id="task">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name ="role" id="role" class="form-control @error('role') is-invalid @enderror"  value="{{ old('role') }}" required autocomplete="name" autofocus>
...
$(document).ready(function(){
    $("#task").validate({
        ...
        messages: {
            ...
            email: "Eneter your unique email",
            dob: "Pick your d.o.b",
            gender:"required",
            role: "choose role",
            password: "required",
